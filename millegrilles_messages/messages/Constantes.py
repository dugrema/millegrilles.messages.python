...
ENV_CERT_RENOUVELER = 'CERT_RENOUVELER'
...
REQUETE_MAITREDESCLES_CERTIFICAT = 'certMaitreDesCles'
REQUETE_MESSAGES_CERTIFICAT = 'certificatMessages'

EVENEMENT_MAITREDESCLES_CERTIFICAT = REQUETE_MAITREDESCLES_CERTIFICAT
EVENEMENT_MESSAGES_CERTIFICAT = REQUETE_MESSAGES_CERTIFICAT
EVENEMENT_PING_CEDULE = 'ping'
EVENEMENT_CEDULE = EVENEMENT_PING_CEDULE
EVENEMENT_EVICT_USAGER = 'evictUsager'
